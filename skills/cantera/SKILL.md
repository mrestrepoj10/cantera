...
| `@cantera/crew-avatar` | component | Deterministic construction-crew SVG avatars — hard hats, hi-vis vests, safety glasses, ear defenders — generated from a name with zero dependencies, boring-avatars style. | [references/crew-avatar.md](references/crew-avatar.md) |
