...
| `@cantera/model-upload-page` | block | A complete APS upload page: scoped Autodesk sign-in with write access, a project and folder destination picker, translation options, direct-to-storage signed S3 uploads with progress, and per-file translation tracking. | [references/model-upload-page.md](references/model-upload-page.md) |
