...
- Registry dependencies: sidebar, @cantera/finder, @cantera/hub-tree
...
- `header / footer` (`ReactNode`) — Rendered above the finder (a hub switcher, a title) and in the sidebar footer.
