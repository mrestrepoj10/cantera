  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-6 py-12 sm:py-16">
      ...
      <p className="mt-2 max-w-2xl text-muted-foreground text-sm">
        Every registry item — components take cantera's oauth types as props; lib items ship the
        types and provider presets they build on. Install any of them with the shadcn CLI.
      </p>
      <div className="mt-10">
        <ComponentGrid />
      </div>
